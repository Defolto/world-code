...
Числа — ориентир. **Окончательно фиксируются по эталонному персонажу**,
и до этого предметы потоком не генерируются: смена эталона — это
перегенерация всего.
...
Генерируется один раз, 10–20 вариантов, выбирается лучший. Дальше он
референс для всего.
...
это то, из чего всё пересобирается, и то, что нужно перегенерировать при
смене эталона.

## Порядок

1. Эталонный персонаж (A) — до принятия ничего другого не генерировать.
